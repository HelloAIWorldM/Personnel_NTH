...
export const ClassStatsBar: React.FC<ClassStatsBarProps> = ({
  ...
  return (
    <div
      ...
      className="bg-white border border-slate-200 rounded-xl p-3 sm:p-4 shadow-xs mb-4 sm:mb-6"
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 mb-3 pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2">
          <Users className="w-4 h-4 sm:w-5 sm:h-5 text-slate-700 shrink-0" />
          <span className="font-bold text-slate-800 text-xs sm:text-sm uppercase tracking-wide">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 text-[11px] sm:text-xs font-semibold overflow-x-auto pb-0.5 sm:pb-0">
          <div className="flex items-center gap-1 sm:gap-1.5 px-2 py-1 bg-amber-50 text-amber-800 rounded-md border border-amber-200 shrink-0">
            <Shield className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-600" />
            <span>Tank:</span>
            <span className="font-bold text-xs sm:text-sm text-amber-900">{tankCount}</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-1.5 px-2 py-1 bg-emerald-50 text-emerald-800 rounded-md border border-emerald-200 shrink-0">
            <Heart className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-600" />
            <span>Healer:</span>
            <span className="font-bold text-xs sm:text-sm text-emerald-900">{healerCount}</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-1.5 px-2 py-1 bg-blue-50 text-blue-800 rounded-md border border-blue-200 shrink-0">
            <Sword className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-600" />
            <span>DPS:</span>
            <span className="font-bold text-xs sm:text-sm text-blue-900">{dpsCount}</span>
          </div>
        </div>
      </div>
